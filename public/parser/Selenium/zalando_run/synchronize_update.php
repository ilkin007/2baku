...
//This script just adds new products from staging database to the shopify

use App\Connect;
use App\ProjectConfig;
use App\Zalando\UpdateSynchronizer;
use Monolog\Logger;
...
$productSynchronizer = new UpdateSynchronizer($shopifyAuthConfig, $db, $log, 'zalando');


//$getProducts = $productSynchronizer->shopify->Product->get();
//var_dump($getProducts);

//$productSynchronizer->initialize();
$productSynchronizer->initialize();
